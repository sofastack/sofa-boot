...
import com.alipay.sofa.autoconfigure.test.runtime.base.AbstractTestBase;
import com.alipay.sofa.autoconfigure.test.runtime.beans.SampleServiceAspect;
...
import com.alipay.sofa.autoconfigure.test.runtime.beans.SampleServiceAnnotationImplWithMethod;
import com.alipay.sofa.autoconfigure.test.runtime.beans.SampleServiceAnnotationImplWithUniqueId;
...
public class IntegrationTest extends AbstractTestBase {
    ...
    public void testSofaRuntimeAwareTest() {
        ...
        Assert.assertTrue(sofaRuntimeContext.getAppName().equals("autoconfigure-test"));
    ...
    public void testFactoryBean() {
        ...
        /**
         * {@link com.alipay.sofa.runtime.test.base.AbstractTestBase.IntegrationTestConfiguration.BeforeConfiguration}
         */
        serviceFactoryBean = (ServiceFactoryBean) applicationContext
            .getBean("&"
                     + SofaBeanNameGenerator.generateSofaServiceBeanName(SampleService.class,

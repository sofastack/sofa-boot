...
import com.alipay.sofa.autoconfigure.test.runtime.beans.BeanPostProcessorTestBean;
import com.alipay.sofa.autoconfigure.test.runtime.beans.HigherOrderBeanPostProcessor;
...
public class BeanPostProcessorOrderTest {
    ...
    public void testShutDownHook() throws Exception {
        List<RuntimeShutdownCallback> applicationShutdownCallbacks = getApplicationShutdownCallbacks();
    ...
    public void testShutDownHookReordered() throws Exception {
        ...
        for (RuntimeShutdownCallback applicationShutdownCallback : applicationShutdownCallbacks) {
    ...
    @SuppressWarnings("unchecked")
    private List<RuntimeShutdownCallback> getApplicationShutdownCallbacks() throws Exception {
        ...
        Field applicationShutdownCallbacksField = sofaRuntimeManager.getClass().getDeclaredField(
            "runtimeShutdownCallbacks");
        applicationShutdownCallbacksField.setAccessible(true);
        return (List<RuntimeShutdownCallback>) applicationShutdownCallbacksField

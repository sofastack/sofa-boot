...
public class StartupContextRefreshedListener implements ApplicationListener<ContextRefreshedEvent>,
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        BeanCostBeanPostProcessor beanCostBeanPostProcessor = event.getApplicationContext()
        ...
        event.getApplicationContext().getBean(StartupReporter.class)
            .addCommonStartupStat(stageStat);
    }

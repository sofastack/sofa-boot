...
public class SofaBootComponentsEndpointTest {
    ...
    @InjectMocks
    private SofaBootComponentsEndPoint sofaBootComponentsEndPoint;
    ...
    public void testComponents() {
        ...
        Assert.assertEquals("testSofaService",
            ((List<SofaBootComponentsEndPoint.ComponentDisplayInfo>) serviceComponentCollection)
                .get(0).getName());
        ...
        Assert.assertEquals("testSofaExt",
            ((List<SofaBootComponentsEndPoint.ComponentDisplayInfo>) extComponentCollection).get(0)
                .getName());

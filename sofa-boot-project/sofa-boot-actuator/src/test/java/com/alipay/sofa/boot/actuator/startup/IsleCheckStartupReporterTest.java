...
//        Assert.assertEquals(ChildBean.CHILD_INIT_TIME + ParentBean.PARENT_INIT_TIM,  parentBeanStat.getRefreshElapsedTime(), 20);
//        Assert.assertEquals(ParentBean.PARENT_INIT_TIM, parentBeanStat.getRealRefreshElapsedTime(), 20);
//        Assert.assertEquals(ParentBean.PARENT_INIT_TIM, parentBeanStat.getAfterPropertiesSetTime(), 20);
...
//        Assert.assertEquals(ChildBean.CHILD_INIT_TIME, childBeanStat.getRealRefreshElapsedTime(), 15);
//        Assert.assertEquals(ChildBean.CHILD_INIT_TIME, childBeanStat.getInitTime(), 10);
...
//        Assert.assertEquals( "com.alipay.sofa.boot.actuator.startup.beans.facade.SampleService", serviceBeanStat.getInterfaceType());
//
//        // test sofa reference
...
//        Assert.assertEquals( "com.alipay.sofa.boot.actuator.startup.beans.facade.TestService", referenceBeanStat.getInterfaceType());
//
//        // test extension bean

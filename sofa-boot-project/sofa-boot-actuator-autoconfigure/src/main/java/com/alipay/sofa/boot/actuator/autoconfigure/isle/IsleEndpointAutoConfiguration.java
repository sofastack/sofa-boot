...
/**
 *  * {@link EnableAutoConfiguration Auto-configuration} for {@link IsleEndpoint}.
 *
 * @author huzijie
 * @version IsleEndpointAutoConfiguration.java, v 0.1 2023年10月10日 3:51 PM huzijie Exp $
 */
...
@ConditionalOnAvailableEndpoint(endpoint = IsleEndpoint.class)
public class IsleEndpointAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean
    public IsleEndpoint isleEndPoint(ApplicationRuntimeModel applicationRuntimeModel) {
        return new IsleEndpoint(applicationRuntimeModel);
    }
}

 ...
 */
package com.alipay.sofa.autoconfigure.tracer.flexible;

import com.alipay.common.tracer.core.reporter.facade.Reporter;
import com.alipay.common.tracer.core.span.SofaTracerSpan;
import com.alipay.sofa.boot.autoconfigure.tracer.SofaTracerAutoConfiguration;
import com.alipay.sofa.boot.autoconfigure.tracer.flexible.FlexibleAutoConfiguration;
...
public class FlexibleAutoConfigurationTests {
    ...
    public void useCustomReporter() {
        this.contextRunner
                .withPropertyValues("sofa.boot.tracer.reporterName=com.alipay.sofa.autoconfigure.tracer.flexible.FlexibleAutoConfigurationTests$EmptyReporter")
                .run((context) -> {

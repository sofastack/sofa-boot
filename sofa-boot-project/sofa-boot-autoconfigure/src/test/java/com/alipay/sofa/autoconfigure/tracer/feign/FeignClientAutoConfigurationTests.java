 ...
 */
package com.alipay.sofa.autoconfigure.tracer.feign;

import com.alipay.sofa.boot.autoconfigure.tracer.feign.FeignClientAutoConfiguration;
...
public class FeignClientAutoConfigurationTests {
    ...
    @Test
    public void noFeignContextBeanPostProcessorWhenSofaTracerFeignContextClassNotExist() {
        this.contextRunner.withClassLoader(new FilteredClassLoader(SofaTracerFeignContext.class))
                .run((context) -> assertThat(context)
                        .doesNotHaveBean(FeignContextBeanPostProcessor.class));
    }

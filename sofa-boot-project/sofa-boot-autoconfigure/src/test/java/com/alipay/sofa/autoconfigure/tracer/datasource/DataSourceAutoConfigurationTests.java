 ...
 */
package com.alipay.sofa.autoconfigure.tracer.datasource;

import com.alipay.sofa.boot.autoconfigure.tracer.datasource.DataSourceAutoConfiguration;
...
public class DataSourceAutoConfigurationTests {
    ...
    public void registerDataSourcePostProcessors() {
        this.contextRunner
                .run((context) -> assertThat(context)
                        .hasSingleBean(DataSourceBeanFactoryPostProcessor.class)
    ...
    public void noDataSourcePostProcessorsWhenSmartDataSourceClassNotExist() {
        this.contextRunner.withClassLoader(new FilteredClassLoader(SmartDataSource.class))
                .run((context) -> assertThat(context)
                        .doesNotHaveBean(DataSourceBeanFactoryPostProcessor.class)

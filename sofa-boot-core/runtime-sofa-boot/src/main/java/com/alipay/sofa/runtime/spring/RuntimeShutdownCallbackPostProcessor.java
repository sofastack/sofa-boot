...
public class RuntimeShutdownCallbackPostProcessor implements MergedBeanDefinitionPostProcessor,
    ...
    public RuntimeShutdownCallbackPostProcessor(SofaRuntimeManager sofaRuntimeManager) {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName)
                                                                              throws BeansException {
        if (bean instanceof RuntimeShutdownCallback) {
            sofaRuntimeManager.registerShutdownCallback((RuntimeShutdownCallback) bean);
        }
        return bean;
    }

...
public class AnnotationSampleTest {
    ...
    public void testServiceAnnotationPlaceHolder() {
        ...
        SofaService sofaService = AnnotationSample.class.getAnnotation(SofaService.class);
        PlaceHolderAnnotationInvocationHandler.AnnotationWrapperBuilder<SofaService> builder = PlaceHolderAnnotationInvocationHandler.AnnotationWrapperBuilder.wrap(sofaService)
            .withBinder(binder);
        ...
        Assert.assertEquals("sample-service-uniqueId", delegate.uniqueId());
    ...
    public void testReferenceAnnotationPlaceHolder() throws Exception {
        ...
        PlaceHolderAnnotationInvocationHandler.AnnotationWrapperBuilder<SofaReference> builder = PlaceHolderAnnotationInvocationHandler.AnnotationWrapperBuilder.wrap(
        ...
        Assert.assertEquals("tr", delegateBinding.bindingType());

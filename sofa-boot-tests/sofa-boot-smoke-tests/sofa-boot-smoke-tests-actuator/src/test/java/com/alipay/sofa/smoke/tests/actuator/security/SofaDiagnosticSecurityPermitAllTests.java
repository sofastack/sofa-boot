...
/**
 * Verifies that {@code sofa-diagnostic} is publicly accessible when {@code sensitive=false}.
 *
 * @author xiaosiyuan
 * @version SofaDiagnosticSecurityPermitAllTests.java, v 0.1 2026年04月03日 xiaosiyuan Exp $
 */
@SpringBootTest(classes = ActuatorSofaBootApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
                                                                                                                                       ...
                                                                                                                                       "management.endpoint.sofa-diagnostic.sensitive=false",
                                                                                                                                       "spring.security.user.name=ops",
                                                                                                                                       "spring.security.user.password=123456" })
public class SofaDiagnosticSecurityPermitAllTests {

    @Autowired
    private TestRestTemplate restTemplate;

    @Test
    public void anonymousAccessToSofaDiagnosticReturns200() {

 ...
 */
package com.alipay.sofa.smoke.tests.isle.stage;

import com.alipay.sofa.boot.isle.ApplicationRuntimeModel;
import com.alipay.sofa.boot.isle.deployment.DeploymentDescriptor;
import com.alipay.sofa.boot.isle.stage.SpringContextInstallStage;
import com.alipay.sofa.smoke.tests.isle.IsleSofaBootApplication;
...
/**
 * Integration tests for {@link SpringContextInstallStage}.
 *
 * @author huzijie
 * @version SpringContextInstallStageTests.java, v 0.1 2023年02月02日 7:16 PM huzijie Exp $
 */
@SpringBootTest(classes = IsleSofaBootApplication.class)
@AddCustomJar({ "sample-module", "fail-module" })
...
public class SpringContextInstallStageTests {
    ...
    public void verifyRuntimeModel() {
        ...
        assertThat(applicationRuntimeModel.getInstalled().size()).isEqualTo(1);
